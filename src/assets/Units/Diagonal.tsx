...
const Diagonal = ({ className, style, onClick, colors = {} }: IProps) => {
  ...
  return (
    ...
    >
      ...
      <g id="Layer_3">
        <path
          style={st3}
          d="M236.2,364.9c-0.2,0-1.2,25.6-0.9,28.3c0.5,5.1,4.7,33.8,4.1,39.5c-0.6,5.7-3.8,4.5-4.1,10.6
        ...
        <path
          style={st3}
          d="M235.8,440.4c0,0-29.2,10-36.1,10.9c-6.9,0.9-10.6-1.9-20.3,1.9c-9.7,3.8-34.3,2.8-67.2,1.2
		c-32.9-1.7-45.2-5.9-49-5.9c-3.8,0-14.8-2-14.8-2"
        />
        <path
          style={st3}
          d="M70.1,348.3c0,0,68.6,6.2,85.4,6.2c16.8,0,57.7-4,57.7-4l6.4,55.6l-17,28.6c0,0-94.9,5.2-106,3.8
		s-18-2.6-18-2.6l-17-31.7l7.6-38.6L70.1,348.3z"
        />
        <path
          style={st3}
          d="M83.7,385.2c0,0,8.3,0.9,12.8,2.5c4.5,1.7,4.3,3.4,4.3,3.4s-3.4,23.5-3.5,25c-0.2,1.5-3.5,2.2-8.5,1
		s-11.1-2.8-10.1-6.8s2.6-12.4,2.6-13.1c0-0.8,0.1-5.9,0.3-6.4C81.7,390.2,83.7,385.2,83.7,385.2z"
        />
        <path
          style={st3}
          d="M84.6,405.2c0,0,0.4-12.1,1.9-12.1c1.5-0.1,2.4,0.1,2.5,2.2c0.1,2.1-0.4,3.9-0.9,4.6c-0.5,0.7-3.2,0.3-3.2,0.3
		"
        />
        <path
          style={st3}
          d="M95.9,394.5c0,0-3.8-1-3.9,1.4c-0.1,2.5-1.2,8.6,0.4,9.6c1.6,1,2.5-0.7,2.8-2.6c0.1-0.7,0.2-1.2,0.2-1.6
      ...
      <g id="Layer_2">
        <path
          style={st3}
          d="M231.3,276.9l-3.9,4.4c0,0-10.4,11-17.9,17.3s-40.5,24.3-65.7,33.3s-55,18-55,18l-18.6-1.6l-1.1,8.7L50,362.1
		c0,0,0.1,0.4,0.2,1c-0.4-1.3-0.7-2.4-0.7-2.4s-2.4-9.5-1.9-11.7c0.6-2.1,4.3-6.3,4.8-8s0.9-4.9,0.9-4.9s-0.7-5.7-0.9-9.7
		c-0.2-4-0.1-5.5,0.7-6.9c0.8-1.5,3.1-8.1,1.7-14.5s1.7-24.1,2.4-28c0.7-3.9,4.8-26.6,4.8-26.6l0.2-3.7c0,0,8.5-2.1,11.2-5.9
		c2.7-3.7,0.1-5.4,10.2-9.3c10-3.9,38-16.6,44.7-19.8c6.8-3.2,30.9-10.3,40.8-14.4c9.9-4.1,22.1-7.2,26.7-9.6
		c4.7-2.4,26.7-10.5,26.7-10.5l-2.5,12.1c0,0-4.6,17.9-4.5,24.6s3.2,26.7,7.9,38s6.9,15.6,7.3,17.6
      ...
      <g id="Layer_1">
        <path
          style={st3}
          d="M46.5,367.6c0,0-15.8-0.5-20.8,0.5c-5,0.9-8.5,2.6-8.5,2.6v-4c0,0,3.3-3.3,2.8-9.2s-3.5-17-3.5-17
		s-5.9,0.9-6.9-6.4c-0.9-7.3-1.7-12.5-2.8-15.4c-1.2-2.8-6.2-11.1-5.7-15.8c0.5-4.7,2.6-8.3,5.4-10.4s4.7-10.2,5-14
        ...
        <path
          style={st3}
          d="M46.5,367.6c0,0,3.7,3.1,4.6-0.3c0.8-3.4-1.5-5.7-2.2-10.3s-2.1-6.3-0.5-8.8c1.7-2.5,3.9-4.7,4.4-8.3
        ...
        <path
          style={st3}
          d="M94.2,17.6c0,0,26.3-11.8,56.1-11.8s45.4,1.7,45.9,11.4s-17.3,34.5-40.9,34.3c-23.7-0.2-49.4-10.2-56.5-18.2
		s-7.7-10.8-7.2-12.4C91.9,19.1,94.2,17.6,94.2,17.6z"
        />
        <path
          style={st3}
          d="M107.8,97.8c0,0,22.7,25.8,39.7,24.8c17-0.9,39.5-18.2,39.5-18.2"
        />
        <path
          style={st3}
          d="M222.8,177.6c1-4.8,2-9.6,3-14.2c0.4-1.9,5-42.2,5.4-44"
        />
        <path
          style={st3}
          d="M16.5,340.4c0,0,5.9-2.9,15.3-2.7c9.5,0.2,21.1,1.2,21.1,1.2"
        />
        <path
          style={st3}
          d="M267.9,343.3c0,0-9.4-5.2-16.7-4.5s-15.2,4.7-15.2,4.7"
        />
        <path
          style={st3}
          d="M97.1,88.8c1.3,0,2.4-1.1,2.4-2.4c0-1.3-1.1-2.4-2.4-2.4s-2.4,1.1-2.4,2.4C94.6,87.7,95.7,88.8,97.1,88.8z"
        />
        <path
          style={st3}
          d="M201.2,88.4c1.4,0,2.5-1.1,2.5-2.5s-1.1-2.5-2.5-2.5s-2.5,1.1-2.5,2.5C198.7,87.2,199.8,88.4,201.2,88.4z"
        />
        <path
          style={st3}
          d="M97.1,86.4c0,0-3.8,29.9-3.1,46.2c0.7,16.3,3.5,33.4,2.4,40.9c-1.2,7.6,1.4,19.4,1.4,19.4"
        />
        <path
          style={st3}
          d="M201.2,85.9c0,0-4.4,37.7-4.6,49.1c-0.2,11.4-2.1,28.2-1.4,34.8s-2.1,12.2-2.1,12.2"
        />
      </g>
    </svg>
  );
